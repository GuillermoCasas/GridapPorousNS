...
solve is not over-solved relative to the $O(h^{k_v+1})$ discretisation error; but the stopping decision
...
Bernoulli surrogate, the rate $\varepsilon_k=C_{\mathrm{sf}}h^{k_v+1}$
