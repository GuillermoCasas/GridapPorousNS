...
\extline{%
\begin{tabular}{@{}r@{\quad}p{0.82\textwidth}@{}}
\textit{Called by:} & Inline blue hook in Algorithm~\ref{alg:O} (per extension cycle in the ASGS path); inline blue hook in Algorithm~\ref{alg:C} (once, after the single coupled OSGS solve). See §\ref{sec:mms-hooks}. \\
