...
\KwIn{$i, S_{\mathrm{LS}}, L, \|\hat{\boldsymbol{b}}\|_\infty, \hat\Phi, \Phi, I_{\mathrm{up}}$.}
...
condition is already satisfied. In all three cases an additional
absolute short-circuit fires when the raw $\ell^\infty$ DOF drift drops
below $\textstag$ for $m \ge 2$; this protects against limit-cycle
oscillations that never cleanly satisfy $\tau_{\mathrm{OSGS}}$ or
$\tau_{\mathrm{proj}}$.
