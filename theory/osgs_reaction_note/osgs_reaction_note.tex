...
\begin{align}\label{eq:ASGS-expand}
  B_\mathrm{S}(\boldsymbol{a},\Uh,\Uh)
...
\begin{equation}\label{eq:ASGS-lemma}
  B_\mathrm{S}(\boldsymbol{a},\Uh,\Uh)\ \ge\ C\,\triplenorm{\Uh}^2,
  \qquad
  \triplenorm{\Uh}^2
  = \nu\big\|\alpha^{1/2}\ViscProj\nabla\uh\big\|^2
...
$B_\mathrm{S}(\boldsymbol{a},\Uh,\Uh)\ge c_{\uh}\,\|\uh\|^2+(\text{other nonnegative terms})$
