...
\texttt{test/extended/CocquetExperimentIrregularMesh/data/meshes/freefem/create\_paper\_meshes.edp}
...
\texttt{CocquetExperimentIrregularMesh} driver opts into the FreeFem path via the
