...
%
%  STATUS: the re-centering step described in Section 6 is a PROPOSAL of this
%  note, NOT part of Codina's published iterated-penalty method; it IS
%  implemented in the solver behind the default-off config flag
%  recenter_pressure_between_penalty_passes.  See Section 7 (Provenance).
%==============================================================================
...
re-centering --- our proposal, unverified against the source literature, implemented behind a
default-off flag and not yet adopted by default.}
