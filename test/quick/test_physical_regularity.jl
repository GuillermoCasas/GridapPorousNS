...
# Create a simplified function that runs the true fine mesh PDE solve and interpolates it
function test_regularity()
    ...
    # Force Triangles
    base_config_dict["numerical_method"]["mesh"]["element_type"] = "TRI"
    
    # 1. Run fine mesh solve
    N_ref = 150  # 150 to save time
