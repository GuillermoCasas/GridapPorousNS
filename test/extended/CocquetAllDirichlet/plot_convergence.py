# test/extended/CocquetAllDirichlet/plot_convergence.py
#
# Usage:
#   python plot_convergence.py                          # plots results/convergence_all_dirichlet.h5
...
def _resolve_h5(arg):
    ...
    if arg is None:
        return os.path.join(results_dir, 'convergence_all_dirichlet.h5')
