...
function run_convergence()
    ...
    println("    [mesh] generator = $mesh_generator", isempty(freefem_mesh_dir) ? "" : "  | freefem_mesh_dir = $freefem_mesh_dir")
    ...
    function do_run(k_v::Int, k_p::Int, method::String, porosity_order)
        ...
        mod_ref, X_ref, Y_ref, dΩ_ref, h_ref, alpha_ref, ru_ref, rp_ref, cfg_ref = build_solver(N_ref, base_config_dict, Re, c_in; porosity_order=porosity_order, mesh_generator=mesh_generator, mesh_file=freefem_path_for(N_ref))
        ...
        for N in N_list
            ...
            mod_h, X_h, Y_h, dΩ_h, h_h, alpha_h, ru_h, rp_h, cfg_h = build_solver(N, base_config_dict, Re, c_in; porosity_order=porosity_order, mesh_generator=mesh_generator, mesh_file=freefem_path_for(N))
