# test/extended/CocquetExperimentModifiedCorner/plot_convergence.py
#
# Usage:
#   python plot_convergence.py                              # plots results/convergence_paper_comparison_modified_corner.h5
...
def _resolve_h5(arg):
    ...
    if arg is None:
        return os.path.join(results_dir, 'convergence_paper_comparison_modified_corner.h5')
...
def plot_cocquet(h5_arg=None):
    ...
    plt.suptitle(rf'Cocquet Convergence [Outlet Corners Untagged] ({", ".join(parts)})', fontsize=15)
