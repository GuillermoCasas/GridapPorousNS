...
now unwraps `\amend{…}` before parsing, restoring this script to **4/4** — verified 2026-07-19, when the
suite total stood at 110/110; the total is now **242/242** after the 2026-07-21 every-equation coverage audit.)
