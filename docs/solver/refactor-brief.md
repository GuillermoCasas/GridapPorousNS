...
> **HISTORICAL refactor brief.** The refactor has landed; the current helper layout is mapped in [algorithm-code-mapping.md](algorithm-code-mapping.md). Kept for traceability of the refactor's intent and constraints.
