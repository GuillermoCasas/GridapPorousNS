> **RAW AUDIT TRANSCRIPT (2026-05-18) — historical.** Findings were triaged into [paper-code-divergences.md](paper-code-divergences.md) (the `P-###` items) and [../../docs/lessons_learned.md](../../docs/lessons_learned.md). Kept verbatim for traceability.
