...
3. **External Homotopy Dilution**: If terminal noise floors physically restrict roots natively, the MMS test harness ascends a *clean-to-perturbed* homotopy ladder $eps\_pert = 0 \to 0.1 \to 1.0$, starting from the exact-solution initial guess and only escalating to perturbation if Newton stalls. (Pre-2026-05-26 the order was reversed; that order accepted noise-floor pseudo-roots in extreme-parameter regimes — see `docs/lessons_learned.md` 2026-05-26 entry.)
