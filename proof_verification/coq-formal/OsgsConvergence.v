...
(*  norm:                                                                    *)
(*                                                                           *)
(*    |||U - U_h|||  <=  C_conv * Psi_O(h),                                   *)
(*                                                                           *)
(*  the porosity-weighted broken l2 form eq:MainResult (the error functional  *)
(*  is an abstract nonnegative scalar here, so this composition holds in      *)
(*  either functional; OsgsInterpolation instantiates it as Psi_O).  Write    *)
